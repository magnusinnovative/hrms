frappe.query_reports["Attendance Report"] = {
    ...
    onload: function () {
        frappe.call({
            method: "hrms.hr.report.attendance_report.attendance_report.get_attendance_years",
            callback: function (r) {
                ...
                frappe.call({
                    ...
                    callback: function (res) {
                        if (res.message) {
                            frappe.query_report.set_filter_value("branch", res.message);
                        }
    ...
    formatter: function (value, row, column, data, default_formatter) {
        ...
        if (!summarized_view) {
            if ((group_by && column.colIndex > 3) || (!group_by && column.colIndex > 2)) {
                ...
                else if (value == "P" || value == "WFH") value = "<span style='color:green'>" + value + "</span>";
